...
namespace Game.Input
{
    public class KeyboardSettings : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            KeyboardManager.Instance.AddOnKeyDownEventListener(KeyBindings.NotificationHistory, () => { NotificationHistoryWindowManager.Instance.Active = true; }, KeyEventTag.IgnoreUI);
            ...
            KeyboardManager.Instance.AddOnKeyDownEventListener(KeyBindings.Horn, () => { if (Main.Instance.State == State.Running) { Main.Instance.PlayerCharacter.Horn(); } });
            KeyboardManager.Instance.AddOnKeyDownEventListener(KeyBindings.Stop, () => { if (Main.Instance.State == State.Running) { Main.Instance.PlayerCharacter.Stop(); } });
